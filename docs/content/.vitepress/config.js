...
const rightsSidebar = (lang = '') => [
  {
    ...
    items: [
      { text: lang === 'es' ? 'Resumen' : lang === 'so' ? 'Guud mar' : lang === 'ar' ? 'نظرة عامة' : 'Overview', link: `${lang ? '/locales/' + lang : ''}/rights/` },
      { text: lang === 'es' ? 'En Casa' : lang === 'so' ? 'Guriga' : lang === 'ar' ? 'في المنزل' : 'At Home', link: `${lang ? '/locales/' + lang : ''}/rights/at-home` },
      { text: lang === 'es' ? 'En Público' : lang === 'so' ? 'Meel Dadweyne' : lang === 'ar' ? 'في الأماكن العامة' : 'In Public', link: `${lang ? '/locales/' + lang : ''}/rights/in-public` },
      { text: lang === 'es' ? 'En el Trabajo' : lang === 'so' ? 'Shaqada' : lang === 'ar' ? 'في العمل' : 'At Work', link: `${lang ? '/locales/' + lang : ''}/rights/at-work` },
      { text: lang === 'es' ? 'Durante una Parada de Tráfico' : lang === 'so' ? 'Joojinta Taraafikada' : lang === 'ar' ? 'عند إيقاف السيارة' : 'During a Traffic Stop', link: `${lang ? '/locales/' + lang : ''}/rights/traffic-stop` },
      { text: lang === 'es' ? 'Si Es Detenido' : lang === 'so' ? 'Haddii Lagu Xidho' : lang === 'ar' ? 'إذا تم احتجازك' : 'If Detained', link: `${lang ? '/locales/' + lang : ''}/rights/if-detained` },
      { text: lang === 'es' ? 'Tarjetas para Imprimir' : lang === 'so' ? 'Kaadhadhka Daabacaadda' : lang === 'ar' ? 'بطاقات للطباعة' : 'Printable Cards', link: `${lang ? '/locales/' + lang : ''}/rights/print-cards` },
    ],
  },
]
...
const startCellSidebar = (lang = '') => [
  {
    ...
    items: [
      { text: lang === 'es' ? 'Resumen' : lang === 'so' ? 'Guud mar' : lang === 'ar' ? 'نظرة عامة' : 'Overview', link: `${lang ? '/locales/' + lang : ''}/start-a-cell/` },
...
const securitySidebar = (lang = '') => [
  {
    ...
    items: [
      { text: lang === 'es' ? 'Resumen' : lang === 'so' ? 'Guud mar' : lang === 'ar' ? 'نظرة عامة' : 'Overview', link: `${lang ? '/locales/' + lang : ''}/security/` },
      { text: lang === 'es' ? 'Seguridad del Dispositivo' : lang === 'so' ? 'Amniga Qalabka' : lang === 'ar' ? 'أمان الجهاز' : 'Device Security', link: `${lang ? '/locales/' + lang : ''}/security/devices` },
      { text: lang === 'es' ? 'Seguridad en Comunicaciones' : lang === 'so' ? 'Amniga Isgaarsiinta' : lang === 'ar' ? 'أمان الاتصالات' : 'Communication OpSec', link: `${lang ? '/locales/' + lang : ''}/security/communication` },
      { text: lang === 'es' ? 'Seguridad Física' : lang === 'so' ? 'Amniga Jirka' : lang === 'ar' ? 'الأمان المادي' : 'Physical Security', link: `${lang ? '/locales/' + lang : ''}/security/physical` },
      { text: lang === 'es' ? 'Si Hay Compromiso' : lang === 'so' ? 'Haddii La Khalkhalgeliyo' : lang === 'ar' ? 'إذا تم الاختراق' : 'If Compromised', link: `${lang ? '/locales/' + lang : ''}/security/compromise` },
    ],
  },
]
