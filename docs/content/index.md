...
hero:
  name: "Soteria Model"
  text: "Community Safety Through Solidarity"
  tagline: A replicable blueprint for protecting vulnerable populations through organized mutual aid
  actions:
    - theme: brand
...
features:
  - icon: 🛡️
    title: Safety Through Structure
    details: Compartmentalized cells and segments protect everyone. If one person is compromised, the network stays safe.
  - icon: 🤝
    title: Trust Through Vouching
    details: New members join only when vouched for by existing trusted members. No strangers, no infiltration.
  - icon: 🔒
    title: Privacy by Design
    details: No databases, no tracking, no central authority. Coordination happens through encrypted channels only.
  - icon: 🌱
