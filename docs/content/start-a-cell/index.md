...
2. **Share values** — committed to the [Core Principles](/model/principles)
...
- [ ] Set up initial Signal infrastructure ([guide](/start-a-cell/signal-setup))
...
| Community Need | Suggested First Segment |
|---------------|------------------------|
| Fear of going to work, errands | **Transporters** |
| ICE activity observed | **Sentinels** |
| People don't know their rights | **Legal Observers** |
| Businesses being targeted | **Business Allies** |
| General material needs | **Resource Network** |
...
- [Founding Team Guide](/start-a-cell/founding-team)
- [Signal Setup](/start-a-cell/signal-setup)
- [Onboarding Process](/start-a-cell/onboarding)
- [Templates](/start-a-cell/templates)
