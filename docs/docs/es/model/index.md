...
|-----------|---------|
| [**Células**](/es/model/cells) | Redes autónomas locales, basadas en geografía o comunidad |
| [**Segmentos**](/es/model/segments) | Equipos funcionales (Centinelas, Transportadores, Recursos, etc.) |
| [**Guías**](/es/model/stewards) | Roles de coordinación (Líderes de Segmento, Logística, Incorporación) |
| [**Niveles de Confianza**](/es/model/trust) | Sistema de aval y progresión de prospecto a miembro de confianza |
...
**¿Nuevo en el modelo?** Comienza con [Principios Fundamentales](/es/model/principles) para entender los valores que guían todo.

**¿Listo para construir?** Salta a [Iniciar una Célula](/es/start-a-cell/) para orientación paso a paso.
