...
- Al menos 2 admins por grupo (redundancia)
- Remover miembros prontamente cuando se vayan
- Revisar regularmente la lista de miembros
- Los dispositivos de admin deben tener la más alta seguridad
...
[← Equipo Fundador](/es/start-a-cell/founding-team) | [Proceso de Incorporación →](/es/start-a-cell/onboarding)
